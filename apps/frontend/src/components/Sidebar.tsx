...
import { BadgeCheck, Bot, Files, LayoutDashboard, ListChecks, LogOut, Settings } from "lucide-react";

export type ViewKey = "dashboard" | "agents" | "tasks" | "drafts" | "approvals" | "settings";
